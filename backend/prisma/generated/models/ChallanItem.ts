...
// @ts-nocheck 
/*
 * This file exports the `ChallanItem` model and its related types.
 *
...
export type GetChallanItemAggregateType<T extends ChallanItemAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateChallanItem[P]>
    : Prisma.GetScalarType<T[P], AggregateChallanItem[P]>
}
...
export type GetChallanItemGroupByPayload<T extends ChallanItemGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ChallanItemGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ChallanItemGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ChallanItemGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ChallanItemGroupByOutputType[P]>
      }
    >
  >
...
export type ChallanItemWhereInput = {
  ...
  id?: Prisma.UuidFilter<"ChallanItem"> | string
  challanId?: Prisma.UuidFilter<"ChallanItem"> | string
  productId?: Prisma.UuidFilter<"ChallanItem"> | string
  ...
  unitPrice?: Prisma.DecimalFilter<"ChallanItem"> | runtime.Decimal | runtime.DecimalJsLike | number | string
...
export type ChallanItemScalarWhereWithAggregatesInput = {
  ...
  id?: Prisma.UuidWithAggregatesFilter<"ChallanItem"> | string
  challanId?: Prisma.UuidWithAggregatesFilter<"ChallanItem"> | string
  productId?: Prisma.UuidWithAggregatesFilter<"ChallanItem"> | string
  ...
  unitPrice?: Prisma.DecimalWithAggregatesFilter<"ChallanItem"> | runtime.Decimal | runtime.DecimalJsLike | number | string
}
...
export type ChallanItemOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "challanId" | "productId" | "quantity" | "productName" | "sku" | "unitPrice", ExtArgs["result"]["challanItem"]>
...
export type ChallanItemCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface ChallanItemDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends ChallanItemCountArgs>(
    args?: Prisma.Subset<T, ChallanItemCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ChallanItemCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, ChallanItemGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetChallanItemGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
...
export interface ChallanItemFieldRefs {
  readonly id: Prisma.FieldRef<"ChallanItem", 'String'>
  readonly challanId: Prisma.FieldRef<"ChallanItem", 'String'>
  readonly productId: Prisma.FieldRef<"ChallanItem", 'String'>
  ...
  readonly unitPrice: Prisma.FieldRef<"ChallanItem", 'Decimal'>
}
